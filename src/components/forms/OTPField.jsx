      ...
      <div className="mt-8">
        ...
        <div className="flex flex-row mt-6">
          <input
            ...
            name="d1"
            maxLength={1}
            className="form-control w-12 h-12 focus:shadow-none focus:border-blue-600 rounded-sm mx-1 text-center"
          />
          <input
            value={otp.d2}
        ...
        <div>
          <button
            ...
            className="h-10 mt-10 w-[21rem] bg-blue-500 text-white text-md font-semibold hover:bg-blue-600 rounded-none"
          >
            Verify OTP
          </button>
        </div>
...
const OTPMsg = () => {
  return (
    <div className="flex flex-row items-center">
      <TiTick className="text-3xl text-blue-800" />
